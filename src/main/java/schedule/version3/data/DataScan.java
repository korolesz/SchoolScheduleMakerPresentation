...
public class DataScan {
    ...
    public void scanData() {
        ...
        File classesName = new File("src\\main\\java\\schedule\\version3\\data\\classes.txt");
        ...
        for (int i = 0; i < allClasses.size(); i++) {
            File scheduleData = new File("src\\main\\java\\schedule\\version3\\data\\classes_summary_wGroups.txt");
